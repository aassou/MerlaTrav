								...
								<table class="table table-striped table-bordered table-advance table-hover">
									<thead>
										<tr>
											...
											<th>Prix</th>
											<th class="hidden-phone">Frais</th>
											<th>Pièces</th>
									...
									<tbody>
										...
										?>		
										<tr>
											<td class="hidden-phone highlight">
												<a><?= $terrain->emplacement() ?></a>
											</td>
											<td><?= $terrain->vendeur() ?></td>
											<td class="hidden-phone"><?= $terrain->superficie() ?></td>
											<td><?= $terrain->prix() ?></td>
											<td class="hidden-phone"><?= $terrain->fraisAchat() ?></td>
											<td>
												<a href="#addPieces<?php echo $terrain->id();?>" class="btn mini blue" data-toggle="modal" data-id="<?php echo $terrain->id(); ?>">
												Ajouter
												</a>
											</td>
											<td class="hidden-phone">
												<a href="#updateTerrain<?php echo $terrain->id();?>" data-toggle="modal" data-id="<?php echo $terrain->id(); ?>">
													Modifier
												</a>
											</td>
											<td class="hidden-phone">
												<a href="#deleteTerrain<?php echo $terrain->id();?>" data-toggle="modal" data-id="<?php echo $terrain->id(); ?>">
													Supprimer
												</a>
											</td>
										</tr>
										<!-- add file box begin-->
										<div id="addPieces<?php echo $terrain->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
										...
										<!-- add files box end -->	
										<!-- update box begin-->
										<div id="updateTerrain<?php echo $terrain->id();?>" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
