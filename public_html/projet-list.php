							...
							<div class="row-fluid portfolio-block">
								...
								<div class="span5" style="overflow:hidden;">
									<!--div class="portfolio-info">
										Budget
										<span><?php //echo (int)$projet->budget() ?></span>
									</div>
									<div class="portfolio-info">
										Superficie
										<span><?php //echo (int)$projet->superficie() ?></span>
									</div-->
									<div class="portfolio-info">
									...
									<div class="portfolio-info">
										<a href="contrats-list.php?idProjet=<?= $projet->id() ?>" class="btn green">Lister Clients et Contrats</a>
									...
									<div class="portfolio-info">
										<a href="fournisseur-add.php?idProjet=<?= $projet->id() ?>" class="btn orange">Créer nouvelle Livraison</a>
									</div>
									<div class="portfolio-info">
								...
								<div class="span2 portfolio-btn">
									<a href="#" class="btn bigicn-only"><span>Suivi</span></a>								
								</div>
							</div>
							<br><br>
							<!-- delete box begin-->
