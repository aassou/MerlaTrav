...
$email = $client->email();
//contract text
$somme = $contrat->avance();
$montantMesuel = $contrat->echeance();
...
signature<strong>}</strong> , représentant un premier versement de réservation de l’appartement <strong>".$numeroBien."</strong> dépendant 
...
<page backtop="15mm" backbottom="20mm" backleft="10mm" backright="10mm">
    ...
    <table>
        ...
        <tr>
            <td><strong>Numéro du bien </strong></td>
            <td> : <?= $numeroBien ?></td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width:60%; text-align: center"><strong>Nador, le </strong></td>
        </tr>
    </table>
    <br><br>
    <table border="0">
