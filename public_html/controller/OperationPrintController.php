...
<strong>".$dateOperation."</strong> de Mr/Mme/Mlle: <strong>".$clientNom."</strong>, le montant de <strong>
".$montant." DH</strong>.";

$quittanceText2 = "Relatif à la réservation ".$expressionOrthographe." <strong>".$typeBien."</strong>
 N° <strong>".$nomBien."</strong> ".$etage.", Rue ".$adresse.", <br>dépendant du programme <strong>".$programme."</strong>";
