<?php
    ...
    if( !empty($_POST['code'])){
        ...
        $appartement = new Appartement(array('id' => $idAppartement, 'nom' => $code, 'prix' => $prix,'superficie' => $superficie, 
        'facade' =>$facade, 'status' => $status, 'cave' => $cave, 'niveau' => $niveau, 'nombrePiece' => $nombrePiece));
