...
class ReglementFournisseurManager{
    ...
    public function add(ReglementFournisseur $reglementFournisseur){
        $query = $this->_db->prepare('INSERT INTO t_reglement_fournisseur (dateReglement, montant, idProjet, idFournisseur)
        VALUES (:dateReglement, :montant, :idProjet, :idFournisseur)') 
    ...
    public function getReglementFournisseursByIdFournisseur($idFournisseur){
        ...
        $query = $this->_db->prepare('SELECT * FROM t_reglement_fournisseur WHERE idFounisseur=:idFournisseur 
