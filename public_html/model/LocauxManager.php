...
class LocauxManager{
    ...
    public function add(Locaux $locaux){
        $query = $this->_db->prepare('INSERT INTO t_locaux (nom, superficie, facade, prix, mezzanine, status, idProjet)
        VALUES (:nom, :superficie, :facade, :prix, :mezzanine, :status, :idProjet)') 
