...
class AppartementManager{
    ...
    public function add(Appartement $appartement){
        ...
        'INSERT INTO t_appartement (nom, superficie, prix, niveau, facade, nombrePiece, status, cave, idProjet)
        VALUES (:nom, :superficie, :prix, :niveau, :facade, :nombrePiece, :status, :cave, :idProjet)') 
