						...
						<div class="tab-pane active" id="tab_1">
                           ...
                           <div class="portlet box grey">
                              <div class="portlet-title">
                                 <h4>
                                 	<i class="icon-edit"></i>
                                 	Ajouter une nouvelle opération de paiement pour le contrat : <strong>N°<?= $idContrat ?></strong> 
								...
								<table class="table table-striped table-bordered table-advance table-hover">
									<thead>
										<tr>
											...
											<th>Montant</th>
											<th class="hidden-phone">Quittance de paiement</th>
