														...
														<table class="table table-striped table-bordered table-advance table-hover">
															...
															<tbody>
																...
																<tr>
																	...
																	<td><a href="#"><?= number_format($salaire->prime(), '2', ',', ' ') ?></a></td>
																	<td><a href="#"><?= number_format($salaire->salaire()-$salaire->prime(), '2', ',', ' ') ?></a></td>
																	<td>
																			...
																			<div class="control-group">
																				...
																				<div class="controls">
																					<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
													                                    <input name="dateOpeartion" id="dateOpeartion" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $salaire->dateOperation() ?>" />
														...
														<table class="table table-striped table-bordered table-advance table-hover">
															<thead>
																<tr>
																	...
																	<td><strong><?= number_format($salairesManager->getTotalByIdEmploye($idEmploye), '2', ',', ' ') ?>&nbsp;DH</strong></td>
																</tr>
															</thead>
														</table>
													</div>
																	...
																	<div class="modal-body">
																		<form class="form-horizontal" action="controller/EmployeSocieteCongeUpdateController.php" method="post" enctype="multipart/form-data">
																			...
																			<div class="control-group">
																				...
																				<div class="controls">
																					<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
													                                    <input name="dateDebut" id="dateDebut" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $employe->dateDebut() ?>" />
													                                    <span class="add-on"><i class="icon-calendar"></i></span>
													                                </div>
																				</div>
																			</div>
																			<div class="control-group">
																				...
																				<div class="controls">
																					<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
													                                    <input name="dateFin" id="dateFin" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $employe->dateSortie() ?>" />
													                                    <span class="add-on"><i class="icon-calendar"></i></span>
													                                </div>
																				</div>
																			</div>
									...
									<div class="modal-body">
										<form class="form-horizontal" action="controller/EmployeSocieteUpdateController.php?param=2" method="post" enctype="multipart/form-data">
											...
											<div class="control-group">
												...
												<div class="controls">
													<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
					                                    <input name="dateSortie" id="dateSortie" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $employe->dateSortie() ?>" />
					                                    <span class="add-on"><i class="icon-calendar"></i></span>
					                                </div>
												</div>
											</div>
									...
									<div class="modal-body">
										<form class="form-horizontal" action="controller/EmployeSocieteCongeAddController.php" method="post" enctype="multipart/form-data">
											...
											<div class="control-group">
												...
												<div class="controls">
													<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
					                                    <input name="dateFin" id="dateFin" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= date('Y-m-d') ?>" />
					                                    <span class="add-on"><i class="icon-calendar"></i></span>
					                                </div>
												</div>
											</div>	
