										...
										<tr>
											...
											<td class="hidden-phone">
												...
												<a href="#updateClient<?= $appartement->id() ?>" data-toggle="modal" data-id="<?= $appartement->id() ?>">
													...
													- Le : <?= date('d/m/Y', strtotime($appartement->dateReservation())) ?>
												<?php
												}
												?>
											</td>
												...
												<form class="form-horizontal" action="controller/AppartementUpdateController.php?p=1" method="post">
													...
													<div class="control-group">
														...
														<select name="status" class="m-wrap">
															<option value="Disponible" <?php echo $statusReserve; echo $statusNonReserve ?> >
																Disponible
															</option>
														...
														<select name="cave" class="m-wrap">
															<option value="<?= $appartement->cave() ?>" selected="selected" >
																<?= $appartement->cave() ?>
															</option>
                                          ...
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
				                                    <input name="dateReservation" id="dateReservation" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= date('Y-m-d') ?>" />
