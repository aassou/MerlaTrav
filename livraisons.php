						...
						<div class="row-fluid">
							<form action="" method="post">
							    <div class="input-box autocomplet_container">
									<input class="m-wrap" name="recherche" id="nomFournisseur" type="text" onkeyup="autocompletFournisseur()" placeholder="Fournisseur">
												...
												<div class="btn-group">
												    ...
												    <ul class="dropdown-menu">
												        <li>
															...
															<a href="livraison-pieces.php?idLivraison=<?= $livraison->id() ?>" data-toggle="modal" data-id="<?= $livraison->id() ?>">
