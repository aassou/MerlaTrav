...
class LivraisonDetailManager{
    ...
    public function add(LivraisonDetail $livraison){
        $query = $this->_db->prepare('INSERT INTO t_livraison_detail (libelle, designation, quantite, 
        prixUnitaire, idLivraison)
        VALUES (:libelle, :designation, :quantite, :prixUnitaire, :idLivraison)') 
    ...
    public function update(LivraisonDetail $livraison){
        $query = $this->_db->prepare('UPDATE t_livraison_detail SET libelle=:libelle, designation=:designation,
