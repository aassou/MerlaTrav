				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="row-fluid add-portfolio">
	                     ...
	                     ?>
	                    <h3>Résumé du Contrat&nbsp;<a class="btn big blue" href="controller/ContratClientSituationPrintController.php?codeContrat=<?= $contrat->code() ?>">Version Imprimable</a></h3>
	                    <hr>
						...
						Prix Vente - Réglements = <?= number_format($contrat->prixVente()-($contrat->avance()+$sommeOperations), 2, ',', ' ') ?>&nbsp;DH
	                    <hr>
                       <div class="span5">
						...
						<div class="portlet sale-summary">
							...
							<ul class="unstyled">
								...
								<li>
									...
									<span class="sale-num"><?= number_format($sommeOperations, 2, ',', ' ') ?></span>
								</li>
								<li>
									<span class="sale-info">Echeance</span> 
									<span class="sale-num"><?= number_format($contrat->echeance(), 2, ',', ' ') ?></span>
								</li>
							</ul>
