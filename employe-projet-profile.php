																			...
																			<div class="control-group">
																				...
																				<div class="controls">
																					<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
													                                    <input name="dateOperation" id="dateOperation" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $salaire->dateOperation() ?>" />
																	...
																	<div class="modal-body">
																		<form class="form-horizontal" action="controller/EmployeProjetCongeUpdateController.php" method="post" enctype="multipart/form-data">
																			...
																			<div class="control-group">
																				...
																				<div class="controls">
																					<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
													                                    <input name="dateDebut" id="dateDebut" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $conge->dateDebut() ?>" />
													                                    <span class="add-on"><i class="icon-calendar"></i></span>
													                                </div>
																				</div>
																			</div>
																			<div class="control-group">
																				...
																				<div class="controls">
																					<div class="input-append date date-picker" data-date="" data-date-format="yyyy-mm-dd">
													                                    <input name="dateFin" id="dateFin" class="m-wrap m-ctrl-small date-picker" type="text" value="<?= $conge->dateFin() ?>" />
													                                    <span class="add-on"><i class="icon-calendar"></i></span>
													                                </div>
																				</div>
																			</div>
